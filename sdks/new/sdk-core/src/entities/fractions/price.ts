...
export class Price<TBase extends Currency, TQuote extends Currency> extends Fraction {
   ...
   */
  public override multiply<TOtherQuote extends Currency>(other: Price<TQuote, TOtherQuote>): Price<TBase, TOtherQuote> {
  ...
  public override toFixed(decimalPlaces = 4, format?: { groupSeparator?: string }, rounding?: Rounding): string {
