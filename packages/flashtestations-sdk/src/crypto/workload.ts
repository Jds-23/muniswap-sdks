...
import type { SingularWorkloadMeasurementRegisters, WorkloadMeasurementRegisters } from '../types/index'
import { validateSingularWorkloadMeasurementRegisters, validateWorkloadMeasurementRegisters } from '../types/validation'
...
function hexToBytes(hex: string): Uint8Array {
  ...
  return Uint8Array.from(unprefixedHex.match(/.{1,2}/g)!.map((byte) => Number.parseInt(byte, 16)))
}
