...
import type { VerificationResult, WorkloadMeasurementRegisters } from '../../types'
import { verifyFlashtestationInBlock } from '../../verification/service'
import { addChainFlags, getChainDisplayName, resolveChainConfig } from '../utils/chainFlags'
import type { ChainOptions } from '../utils/chainFlags'
import {
  handleError,
  outputJson,
  printFailure,
