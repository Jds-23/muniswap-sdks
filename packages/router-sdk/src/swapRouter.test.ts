...
import { type BigintIsh, CurrencyAmount, Ether, Percent, Token, TradeType, WETH9 } from '@muniswap/sdk-core'
import { Pair, Route as V2Route, Trade as V2Trade } from '@muniswap/v2-sdk'
import {
  encodeSqrtRatioX96,
  FeeAmount,
  getTickAtSqrtRatio,
...
import { swapCallParameters, swapAndAddCallParameters, Trade } from '.'
...
describe('SwapRouter', () => {
  ...
  const makeV3Pool = (token0: Token, token1: Token, liquidity: number) => {
    return new V3Pool(token0, token1, feeAmount, sqrtRatioX96, liquidity, getTickAtSqrtRatio(sqrtRatioX96), [
      {
        index: nearestUsableTick(MIN_TICK, TICK_SPACINGS[feeAmount]!),
        liquidityNet: liquidity,
        liquidityGross: liquidity,
  ...
  const makePair = (token0: Token, token1: Token, liquidity: BigintIsh) => {
    const amount0 = CurrencyAmount.fromRawAmount(token0, BigInt(liquidity))
    const amount1 = CurrencyAmount.fromRawAmount(token1, BigInt(liquidity))
  ...
  describe('#swapCallParameters', () => {
    describe('single-hop exact input (v2 + v3)', () => {
      describe('different trade configurations result in identical calldata', () => {
        ...
        const amountIn = CurrencyAmount.fromRawAmount(token0, BigInt(100))
        ...
        it('array of trades', async () => {
          ...
          const { calldata, value } = swapCallParameters(trades, {
            slippageTolerance,
            recipient,
    ...
    describe('single-hop exact output (v2 + v3)', () => {
      describe('different trade configurations result in identical calldata', () => {
        ...
        const amountOut = CurrencyAmount.fromRawAmount(token1, BigInt(100))
    ...
    describe('multi-hop exact output (v2 + v3)', () => {
      describe('different trade configurations result in identical calldata', () => {
        ...
        const amountOut = CurrencyAmount.fromRawAmount(WETH, BigInt(100))
    ...
    describe('Mixed Route', () => {
      it('throws an error with v4 pool', async () => {
        const amountIn = CurrencyAmount.fromRawAmount(WETH, BigInt(100))
      ...
      describe('single-hop exact input (v2 + v3) backwards compatible', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          it('generates the same calldata', async () => {
            ...
            const { calldata: mixedRouteCalldata, value: mixedRouteValue } = swapCallParameters(
              mixedRouteTrades,
              {
                slippageTolerance,
                recipient,
    ...
    describe('ETH input', () => {
      describe('single-hop exact input (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const amountIn = CurrencyAmount.fromRawAmount(ETHER, BigInt(100))
      ...
      describe('multi-hop exact output (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const amountOut = CurrencyAmount.fromRawAmount(token0, BigInt(100))
      ...
      describe('high price impact with ERCO20 input does not result in refundETH call', () => {
        ...
        const amountIn = CurrencyAmount.fromRawAmount(token1, BigInt(100))
        const pool_V3_1_WETH_slippage = makeV3Pool(token1, WETH, 100)
        const REFUND_ETH_FUNCTION_SIG = /12210e8a/
    ...
    describe('ETH output', () => {
      ...
      describe('single-hop exact output (v2 + v3)', () => {
        describe('different trade configurations result in identical calldata', () => {
          ...
          const amountOut = CurrencyAmount.fromRawAmount(ETHER, BigInt(100))
    ...
    describe('#swapAndAddCallParameters', () => {
      describe('single-hop trades', () => {
        const expectedCalldata =
          ''
        const amountIn = CurrencyAmount.fromRawAmount(token0, BigInt(10))
        const v2Trade = V2Trade.exactIn(new V2Route([pair_0_1], token0, token1), amountIn)
        /// mirrors V2Trade
        const mixedRouteTrade2 = MixedRouteTrade.fromRoute(
          new MixedRouteSDK([pair_0_1], token0, token1),
        ...
        it('correctly encodes the entire swap process', async () => {
          const trades = [v2Trade, await v3Trade]
          const methodParameters = swapAndAddCallParameters(
            trades,
            { slippageTolerance },
            position,
            addLiquidityOptions,
      ...
      describe('multi-hop trades', () => {
        const expectedCalldata =
          ''
      ...
      describe('adding liquidity to an existing position', () => {
        const expectedCalldata =
          ''
        const amountIn = CurrencyAmount.fromRawAmount(token0, BigInt(10))
        const v2Trade = V2Trade.exactIn(new V2Route([pair_0_1], token0, token1), amountIn)
        const mixedRouteTrade2 = MixedRouteTrade.fromRoute(
          new MixedRouteSDK([pair_0_1], token0, token1),
      ...
      describe('when MAX tokens must be approved to the NFT Manager', () => {
        const expectedCalldata =
          ''
        const amountIn = CurrencyAmount.fromRawAmount(token0, BigInt(10))
        const v2Trade = V2Trade.exactIn(new V2Route([pair_0_1], token0, token1), amountIn)
        const mixedRouteTrade2 = MixedRouteTrade.fromRoute(
          new MixedRouteSDK([pair_0_1], token0, token1),
      ...
      describe('when MAX_MINUS_ONE tokens must be approved to the NFT Manager', () => {
        const expectedCalldata =
          ''
        const amountIn = CurrencyAmount.fromRawAmount(token0, BigInt(10))
        const v2Trade = V2Trade.exactIn(new V2Route([pair_0_1], token0, token1), amountIn)
        const mixedRouteTrade2 = MixedRouteTrade.fromRoute(
          new MixedRouteSDK([pair_0_1], token0, token1),
      ...
      describe('when ZERO_THEN_MAX tokens must be approved to the NFT Manager', () => {
        const expectedCalldata =
          ''
        const amountIn = CurrencyAmount.fromRawAmount(token0, BigInt(10))
        const v2Trade = V2Trade.exactIn(new V2Route([pair_0_1], token0, token1), amountIn)
        const mixedRouteTrade2 = MixedRouteTrade.fromRoute(
          new MixedRouteSDK([pair_0_1], token0, token1),
      ...
      describe('when ZERO_THEN_MAX_MINUS_ONE tokens must be approved to the NFT Manager', () => {
        const expectedCalldata =
          ''
        const amountIn = CurrencyAmount.fromRawAmount(token0, BigInt(10))
        const v2Trade = V2Trade.exactIn(new V2Route([pair_0_1], token0, token1), amountIn)
        const mixedRouteTrade2 = MixedRouteTrade.fromRoute(
          new MixedRouteSDK([pair_0_1], token0, token1),
      ...
      describe('when input is native', () => {
        const expectedCalldata =
          ''

        const ETH = Ether.onChain(1)
        const amountIn = CurrencyAmount.fromRawAmount(ETH, BigInt(10))
      ...
      describe('when output is native', () => {
        const expectedCalldata =
          ''
        const ETH = Ether.onChain(1)
        const amountIn = CurrencyAmount.fromRawAmount(token1, BigInt(10))
