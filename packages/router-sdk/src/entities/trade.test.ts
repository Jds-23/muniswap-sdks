...
import { sqrt, Token, CurrencyAmount, TradeType, WETH9, Ether, Percent, Price } from '@muniswap/sdk-core'
...
import { Pair, Route as V2RouteSDK } from '@muniswap/v2-sdk'
import { MixedRouteSDK } from './mixedRoute/route'
import { Route as V4RouteSDK, Pool as V4Pool } from '@muniswap/v4-sdk'
...
describe('Trade', () => {
  ...
  const pool_1_2 = v2StylePool(
    CurrencyAmount.fromRawAmount(token1, BigInt(12000)),
    CurrencyAmount.fromRawAmount(token2, BigInt(10000))
  )

  const pool_0_3 = v2StylePool(
    CurrencyAmount.fromRawAmount(token0, BigInt(10000)),
    CurrencyAmount.fromRawAmount(token3, BigInt(10000))
  )

  const pair_0_1 = new Pair(
    CurrencyAmount.fromRawAmount(token0, BigInt(12000)),
    CurrencyAmount.fromRawAmount(token1, BigInt(12000))
  )
  ...
  const pair_0_2 = new Pair(
    CurrencyAmount.fromRawAmount(token0, BigInt(10000)),
    CurrencyAmount.fromRawAmount(token2, BigInt(12000))
  )
  ...
  const pair_weth_0 = new Pair(
    CurrencyAmount.fromRawAmount(weth, BigInt(10000)),
    CurrencyAmount.fromRawAmount(token0, BigInt(10000))
  )
  const pair_weth_1 = new Pair(
    CurrencyAmount.fromRawAmount(weth, BigInt(10000)),
    CurrencyAmount.fromRawAmount(token1, BigInt(10000))
  )
  ...
  const pair_tax_output = new Pair(
    CurrencyAmount.fromRawAmount(weth, BigInt(100000)),
    CurrencyAmount.fromRawAmount(token4WithTax, BigInt(100000))
  )

  const pair_tax_input = new Pair(
    CurrencyAmount.fromRawAmount(token5WithTax, BigInt(100000)),
    CurrencyAmount.fromRawAmount(weth, BigInt(100000))
  )
    ...
    [
      {
        ...
        liquidityNet: BigInt(10000000000000),
        liquidityGross: BigInt(10000000000000),
      },
      {
        index: nearestUsableTick(MAX_TICK, TICK_SPACINGS[FeeAmount.MEDIUM]!),
        liquidityNet: BigInt(10000000000000) * BigInt(-1),
        liquidityGross: BigInt(10000000000000),
      },
    ]
  )
  ...
  describe('#fromRoute', () => {
    it('can contain only a v3 route', async () => {
      ...
      const amount = CurrencyAmount.fromRawAmount(token0, BigInt(1000))
    ...
    it('can contain only a v2 route', async () => {
      ...
      const amount = CurrencyAmount.fromRawAmount(token1, BigInt(1000))
    ...
    it('can be constructed with ETHER as input for a V3 Route exact input swap', async () => {
      ...
      const route = new RouteV3(routeOriginal)
      const amount = CurrencyAmount.fromRawAmount(ETHER, BigInt(10))
    ...
    it('can be constructed with ETHER as input for a V3 Route exact output swap', async () => {
      const routeOriginal = new V3RouteSDK([pool_weth_0], ETHER, token0)
      const route = new RouteV3(routeOriginal)
      const amount = CurrencyAmount.fromRawAmount(token0, BigInt(100))
    ...
    it('can be constructed with ETHER as output for a V3 Route exact output swap', async () => {
      ...
      const route = new RouteV3(routeOriginal)
      const amount = CurrencyAmount.fromRawAmount(ETHER, BigInt(100))
    ...
    it('can be constructed with ETHER as input for a V2 Route exact output swap', async () => {
      const routeOriginal = new V2RouteSDK([pair_weth_2], ETHER, token2)
      const route = new RouteV2(routeOriginal)
      const amount = CurrencyAmount.fromRawAmount(token2, BigInt(100))
    ...
    it('throws if input currency does not match for V3 route', async () => {
      ...
      const amount = CurrencyAmount.fromRawAmount(token2, BigInt(1000))
      const tradeType = TradeType.EXACT_INPUT
  ...
  describe('#fromRoutes', () => {
    it('can contain both a v2 and a v3 route', async () => {
      ...
      const amountv2 = CurrencyAmount.fromRawAmount(token0, BigInt(100))

      const routeOriginalV3 = new V3RouteSDK([pool_0_1, pool_1_2], token0, token2)
      const routev3 = new RouteV3(routeOriginalV3)
      const amountv3 = CurrencyAmount.fromRawAmount(token0, BigInt(1000))
    ...
    it('can contain a v2, a v3, and a mixed route', async () => {
      ...
      const amountMixedRoute = CurrencyAmount.fromRawAmount(token0, BigInt(1000))
    ...
    it('can contain multiple v2, v3, and mixed routes', async () => {
      ...
      const amountMixedRoute2 = CurrencyAmount.fromRawAmount(token0, BigInt(1000))
    ...
    it('can contain muliptle v2 and v3 routes', async () => {
      const routeOriginalV2 = new V2RouteSDK([pair_0_1, pair_1_2], token0, token2)
      const routev2 = new RouteV2(routeOriginalV2)
      const amountv2 = CurrencyAmount.fromRawAmount(token2, BigInt(100))

      const route2OriginalV2 = new V2RouteSDK([pair_weth_0, pair_weth_2], token0, token2)
      const route2v2 = new RouteV2(route2OriginalV2)
      const amount2v2 = CurrencyAmount.fromRawAmount(token2, BigInt(1000))

      const routeOriginalV3 = new V3RouteSDK([pool_0_1, pool_1_2], token0, token2)
      const routev3 = new RouteV3(routeOriginalV3)
      const amountv3 = CurrencyAmount.fromRawAmount(token2, BigInt(1000))

      const route2OriginalV3 = new V3RouteSDK([pool_weth_0, pool_weth_2], token0, token2)
      const route2v3 = new RouteV3(route2OriginalV3)
      const amount2v3 = CurrencyAmount.fromRawAmount(token2, BigInt(1000))
    ...
    it('can be constructed with ETHER as input for exact input', async () => {
      ...
      const routev2 = new RouteV2(routeOriginalV2)
      const amountv2 = CurrencyAmount.fromRawAmount(ETHER, BigInt(100))

      const routeOriginalV3 = new V3RouteSDK([pool_weth_0, pool_0_1], ETHER, token1)
      const routev3 = new RouteV3(routeOriginalV3)
      const amountv3 = CurrencyAmount.fromRawAmount(ETHER, BigInt(1000))

      const mixedRouteOriginal = new MixedRouteSDK([pool_weth_2, pair_1_2], ETHER, token1)
      const mixedRoute = new MixedRoute(mixedRouteOriginal)
      const amountMixedRoute = CurrencyAmount.fromRawAmount(ETHER, BigInt(1000))
    ...
    it('can be constructed with ETHER as input for exact output', async () => {
      const routeOriginalV2 = new V2RouteSDK([pair_weth_0, pair_0_1], ETHER, token1)
      const routev2 = new RouteV2(routeOriginalV2)
      const amountv2 = CurrencyAmount.fromRawAmount(token1, BigInt(100))

      const routeOriginalV3 = new V3RouteSDK([pool_weth_0, pool_0_1], ETHER, token1)
      const routev3 = new RouteV3(routeOriginalV3)
      const amountv3 = CurrencyAmount.fromRawAmount(token1, BigInt(1000))
    ...
    it('can be constructed with ETHER as output for exact input swap', async () => {
      ...
      const mixedRoute = new MixedRoute(mixedRouteOriginal)
      const amountMixedRoute = CurrencyAmount.fromRawAmount(token1, BigInt(1000))
    ...
    it('can be constructed with ETHER as input for exact input swap, with V4 eth route and V2 weth route', async () => {
      ...
      const amountv4 = CurrencyAmount.fromRawAmount(ETHER, BigInt(1000))
    ...
    it('can be constructed with ETHER as input for exact output swap, with V4 eth route and V2 weth route', async () => {
      ...
      const routeOriginalV4 = new V4RouteSDK([pool_v4_1_eth], ETHER, token1)
      const routev4 = new RouteV4(routeOriginalV4)
      const amountv4 = CurrencyAmount.fromRawAmount(token1, BigInt(1000))
    ...
    it('throws if pools are re-used between V3 routes', async () => {
      ...
      const route2v3 = new RouteV3(route2OriginalV3)
      const amount2v3 = CurrencyAmount.fromRawAmount(token0, BigInt(1000))
    ...
    it('throws if pools are re-used between V2 routes', async () => {
      ...
      const route2v2 = new RouteV2(route2OriginalV2)
      const amount2v2 = CurrencyAmount.fromRawAmount(token0, BigInt(1000))
    ...
    it('throws if trade is created with EXACT_OUTPUT and contains mixedRoutes', async () => {
      ...
      const mixedRoute = new MixedRoute(mixedRouteOriginal)
      const mixedRouteAmount = CurrencyAmount.fromRawAmount(token1, BigInt(1000))
  ...
  describe('#minimumAmountOut', () => {
    describe('tradeType = EXACT_INPUT', () => {
      ...
      it('throws if less than 0', () => {
        expect(() => trade.minimumAmountOut(new Percent(BigInt(-1), 100))).toThrow('SLIPPAGE_TOLERANCE')
      })

      it('returns exact if 0', () => {
        expect(trade.minimumAmountOut(new Percent(BigInt(0), 100))).toEqual(trade.outputAmount)
      })

      it('returns exact if nonzero', () => {
        expect(trade.minimumAmountOut(new Percent(BigInt(5), 100))).toEqual(
          CurrencyAmount.fromRawAmount(token1, 285) // 300 * 0.95
        )
        expect(trade.minimumAmountOut(new Percent(BigInt(200), 100))).toEqual(
  ...
  describe('#maximumAmountIn', () => {
    describe('tradeType = EXACT_INPUT', () => {
      ...
      it('throws if less than 0', () => {
        expect(() => trade.maximumAmountIn(new Percent(BigInt(-1), 100))).toThrow('SLIPPAGE_TOLERANCE')
      })

      it('returns exact if 0', () => {
        expect(trade.maximumAmountIn(new Percent(BigInt(0), 100))).toEqual(trade.inputAmount)
      })

      it('returns exact if nonzero', () => {
        expect(trade.maximumAmountIn(new Percent(BigInt(5), 100))).toEqual(
      ...
      describe('tradeType = EXACT_OUTPUT', () => {
        ...
        it('returns exact if nonzero', () => {
          ...
          expect(trade.maximumAmountIn(new Percent(BigInt(200), 100))).toEqual(
  ...
  describe('#executionPrice', () => {
    it('is correct for tradeType = EXACT_INPUT', async () => {
      ...
      const routev3 = new RouteV3(routeOriginalV3)
      const amountv3 = CurrencyAmount.fromRawAmount(token0, BigInt(100))

      const mixedRouteOriginal = new MixedRouteSDK([pair_weth_0, pool_weth_1], token0, token1)
      const mixedRoute = new MixedRoute(mixedRouteOriginal)
      const amountMixed = CurrencyAmount.fromRawAmount(token0, BigInt(100))
    ...
    it('is correct for tradeType = EXACT_OUTPUT', async () => {
      ...
      const routeOriginalV3 = new V3RouteSDK([pool_0_1], token0, token1)
      const routev3 = new RouteV3(routeOriginalV3)
      const amountv3 = CurrencyAmount.fromRawAmount(token1, BigInt(100))
