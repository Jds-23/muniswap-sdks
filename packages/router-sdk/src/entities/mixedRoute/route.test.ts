import { type Currency, CurrencyAmount, Ether, Token, WETH9 } from '@muniswap/sdk-core'
import { Pair, Route as V2RouteSDK } from '@muniswap/v2-sdk'
import { encodeSqrtRatioX96, FeeAmount, getTickAtSqrtRatio, Pool as V3Pool, Route as V3RouteSDK } from '@muniswap/v3-sdk'
...
describe('MixedRoute', () => {
  ...
  describe('#midPrice', () => {
    ...
    const pool_v3_2_weth = new V3Pool(
      ...
      0,
      getTickAtSqrtRatio(encodeSqrtRatioX96(1, 8)),
      []
    )
