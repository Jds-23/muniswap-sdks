import { CurrencyAmount, Ether, Token, WETH9 } from '@muniswap/sdk-core'
import { Pair } from '@muniswap/v2-sdk'
import { encodeSqrtRatioX96, FeeAmount, Pool as V3Pool } from '@muniswap/v3-sdk'
...
describe('#encodeMixedRouteToPath', () => {
  ...
  const route_0_V3_1_v3_weth_V2_2 = new MixedRouteSDK(
    [pool_V3_0_1_medium, pool_V3_1_weth, pair_2_weth],
    token0,
    token2
  )
