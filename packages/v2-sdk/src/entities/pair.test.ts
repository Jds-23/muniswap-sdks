import { ChainId, CurrencyAmount, Price, Token, V2_FACTORY_ADDRESSES, WETH9 } from '@muniswap/sdk-core'
...
describe('Pair', () => {
  ...
  describe('#involvesToken', () => {
    ...
    it('returns false for a token not in the pair', () => {
      expect(
        new Pair(CurrencyAmount.fromRawAmount(USDC, '100'), CurrencyAmount.fromRawAmount(DAI, '100')).involvesToken(
          WETH9[1]!
        )
    ...
    describe('when calculating FOT fees', () => {
      ...
      describe('getOutputAmount', () => {
        it('getOutputAmount for input token BLASTERS and output token BLAST', () => {
          ...
          const expectedOutputBlastAmount = '0.000000000000000090'
