...
describe('encodeRouteToPath', () => {
  ...
  it('packs correctly for exact input single hop', () => {
  ...
  it('packs correctly for exact output single hop', () => {
  ...
  it('packs correctly for exact input multi hop', () => {
  ...
  it('packs correctly for exact output multi hop', () => {
  ...
  it('wraps ether input for exact input multi hop', () => {
  ...
  it('wraps ether input for exact output multi hop', () => {
  ...
  it('wraps ether output for exact input multi hop', () => {
  ...
  it('wraps ether output for exact output multi hop', () => {
